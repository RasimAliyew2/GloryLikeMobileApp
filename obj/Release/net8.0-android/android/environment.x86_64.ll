...
@dso_cache = dso_local local_unnamed_addr global [628 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1706421688814236001, ; hash 0x17ae6d7c26cb7161, from name: GloryLikeMobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GloryLikeMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 50
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2452197380310802631, ; hash 0x2207f4866c91a0c7, from name: aot-GloryLikeMobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GloryLikeMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 77
	...
	%struct.DSOCacheEntry {
		i64 3514165700975437793, ; hash 0x30c4d3161080a7e1, from name: libaot-GloryLikeMobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GloryLikeMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 116
	...
	%struct.DSOCacheEntry {
		i64 3883114008305522613, ; hash 0x35e3979def64d7b5, from name: GloryLikeMobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GloryLikeMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 135
	...
	%struct.DSOCacheEntry {
		i64 11309969016943304256, ; hash 0x9cf514e5eb945e40, from name: aot-GloryLikeMobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GloryLikeMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 376
	...
	%struct.DSOCacheEntry {
		i64 14029511814795483726, ; hash 0xc2b2d6a9fd07da4e, from name: libaot-GloryLikeMobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GloryLikeMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 476
...
@.env.3 = private unnamed_addr constant [37 x i8] c"c7d5f856-4776-4ea3-8b47-f7c9fcdbe57e\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [33 x i8] c"libaot-GloryLikeMobileApp.dll.so\00", align 16
