...
@dso_cache = dso_local local_unnamed_addr global [628 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 888436589, ; hash 0x34f4776d, from name: aot-GloryLikeMobileApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 947105020, ; hash 0x3873acfc, from name: aot-GloryLikeMobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GloryLikeMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 131
	...
	%struct.DSOCacheEntry {
		i64 1036116105, ; hash 0x3dc1e089, from name: libaot-GloryLikeMobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GloryLikeMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 150
	...
	%struct.DSOCacheEntry {
		i64 1811756336, ; hash 0x6bfd3530, from name: GloryLikeMobileApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GloryLikeMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 252
	%struct.DSOCacheEntry {
		i64 1812532655, ; hash 0x6c090daf, from name: libaot-GloryLikeMobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GloryLikeMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 253
	...
	%struct.DSOCacheEntry {
		i64 2407426589, ; hash 0x8f7e6a1d, from name: GloryLikeMobileApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-GloryLikeMobileApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 347
